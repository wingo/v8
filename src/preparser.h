...
#include "src/production-classifier.h"
...
class ParserBase : public Traits {
 ...
 protected:
  ...
  ProductionClassifier::Cursor push_classifier() {
    return production_classifier_.push();
  }
  ...
  typedef ProductionClassifier::Cursor ExpressionClassifier;

  void ReportClassifierError(const ProductionClassifier::Error& error) {
 ...
 private:
  ...
  Scanner* scanner_;
  ProductionClassifier production_classifier_;
  ...
  switch (token) {
    ...
    case Token::LPAREN:
      ...
      if (allow_harmony_arrow_functions() && Check(Token::RPAREN)) {
        ...
        ExpressionClassifier args_classifier = push_classifier();
        bool has_rest = false;
...
typename ParserBase<Traits>::ExpressionT ParserBase<Traits>::ParseExpression(
  ...
  ExpressionClassifier binding_classifier = push_classifier();
  ExpressionT result =
      this->ParseAssignmentExpression(accept_IN, &binding_classifier, CHECK_OK);
  classifier->Accumulate(binding_classifier,
                         ProductionClassifier::AllProductions);
...
ParserBase<Traits>::ParseAssignmentExpression(bool accept_IN,
  ...
  ExpressionClassifier arrow_formals_classifier = push_classifier();
  ...
  classifier->Accumulate(arrow_formals_classifier,
                         ProductionClassifier::FormalParametersProductions);
